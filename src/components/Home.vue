      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">2017 . Drame/Science fiction film . 2h 21m</span>
          </div>
        </v-card-title>
        <v-card-text>
          In the near future, a weary Logan (Hugh Jackman) cares for anailing Professor X (Patrick Stewart) at a remote outpost on the Mexican border. a young protect His plan to hide from the outside world gets upended when he meets mutant (Dafne Keen) who is very much like him. Logan must now the girl and battle the dark forces that want to capture her.
        </v-card-text>
        <v-card-actions>
          <v-btn text color="purple">Rate this movie</v-btn>
          <v-spacer></v-spacer>
